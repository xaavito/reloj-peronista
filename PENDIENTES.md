# Pendientes - Reloj Peronista

## 🐛 BUGS

### Alta Prioridad

- [ ] **Snooze podría tener el mismo problema**
  - Problema: Verificar si el snooze tiene comportamiento similar (se detiene y vuelve)
  - Solución propuesta: Revisar lógica de snooze similar a la alarma
...
1. Arreglar bug de alarma que vuelve a sonar
